...
_G.packer_plugins = {
  ...
  ["black-nvim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/black-nvim",
  ...
  ["nvim-dev-container"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/nvim-dev-container",
  ...
  ["nvim-remote-containers"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/nvim-remote-containers",
  ...
  ["tag-peek.vim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/tag-peek.vim",
